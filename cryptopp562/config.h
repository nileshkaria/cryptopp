...
// NOTE: Added for building for OSX and iOS 
...
//NOTE: cpu.h:53 uses an explicit asm statement. This means GCC only knows that you've got certain 
//parameters that have to be in certain kinds of registers, and then it fills in some fields in the 
//template describing where those parameters are, and spits out the string for the assembler to process.
